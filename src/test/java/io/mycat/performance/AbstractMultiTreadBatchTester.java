...
public abstract class AbstractMultiTreadBatchTester {
    ...
    private void deleteLastInsert() {
        try {
            Connection connection = conPool.getConnection();
            Statement st = connection.createStatement();
            int res = st.executeUpdate("delete from tpl");
            System.out.println("delete " + res);
            st.close();
            conPool.returnCon(connection);
    ...
    public void runAndReport() throws InterruptedException {
        ...
        while (!executor.isTerminated()) {
            if (outputMiddleInf) {
                ...
                System.out
                    .println(df.format(new Date()) + " finished records :" + finshiedCount.get() + " failed:"
