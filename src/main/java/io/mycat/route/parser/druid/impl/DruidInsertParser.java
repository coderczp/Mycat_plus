...
public class DruidInsertParser extends DefaultDruidParser {
    ...
    public void statementParse(SchemaConfig schema, RouteResultset rrs,
        ...
        if (tc == null) {
            String msg = String.format("can't find table %s in schema,", tableName, schema.getName());
            LOGGER.warn(msg);
    ...
    private RouteResultset parserChildTable(SchemaConfig schema, RouteResultset rrs, String tableName,
        ...
        RouteResultset theRrs = RouterUtil.routeByERParentKey(null, schema, SQLHandler.Type.INSERT, sql, rrs, tc,
            joinKeyVal);
        if (theRrs != null) {
            rrs.setFinishedRoute(true);
            return theRrs;
     ...
     */
    private void parserSingleInsert(SchemaConfig schema, RouteResultset rrs, String partitionColumn, String tableName,
                                    MySqlInsertStatement insertStmt) throws SQLNonTransientException {
            ...
            if (shardingColIndex == -1) {
                ...
                for (Map.Entry<Integer, List<ValuesClause>> node : nodeValuesMap.entrySet()) {
                    ...
                    if (algorithm instanceof SlotFunction) {
                        ...
                        nodes[count].setStatement(
                            ParseUtil.changeInsertAddSlot(nodes[count].getStatement(), nodes[count].getSlot()));
                    }
