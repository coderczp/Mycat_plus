...
public class MySQLDetector implements SQLQueryResultListener<SQLQueryResult<Map<String, String>>> {
    ...
    public void onResult(SQLQueryResult<Map<String, String>> result) {
        ...
        if (result.isSuccess()) {
            ...
            if (resultResult != null && !resultResult.isEmpty() && switchType == DataHostConfig.SYN_STATUS_SWITCH_DS
                ...
                if (Slave_IO_Running != null && Slave_IO_Running.equals(Slave_SQL_Running)
                    ...
                    if (null != Seconds_Behind_Master && !"".equals(Seconds_Behind_Master)) {
                        ...
                        if (Behind_Master > source.getHostConfig().getSlaveThreshold()) {
                            MySQLHeartbeat.LOGGER.warn(
                                "found MySQL master/slave Replication delay !!! " + heartbeat.getSource().getConfig()
            ...
            } else if (resultResult != null && !resultResult.isEmpty()
                ...
                if ("ON".equals(wsrep_connected) && "ON".equals(wsrep_ready)
                    ...
                    MySQLHeartbeat.LOGGER
                        .warn("found MySQL  cluster status err !!! " + heartbeat.getSource().getConfig()
                              + " wsrep_cluster_status: " + wsrep_cluster_status + " wsrep_connected: "
                              + wsrep_connected + " wsrep_ready: " + wsrep_ready);
