...
public final class NIOReactor {
    ...
    final Queue<NIOConnection> getRegisterQueue() {
            ...
            while ((c = registerQueue.poll()) != null) {
                try {
                    if (c instanceof AbstractConnection) {
                        AbstractConnection cc = (AbstractConnection) c;
                        ((NIOSocketWR) cc.getSocketWR()).register(selector);
                        c.register();
                    } else {
                        LOGGER.info("not AbstractConnection {}", c);
                    }
                } catch (Exception e) {
