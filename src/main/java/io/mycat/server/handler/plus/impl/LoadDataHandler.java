...
/**
 * @author jeff.cao
 * @version 0.0.1, 2018年4月26日 下午2:00:56 
 */
public class LoadDataHandler implements SQLHandler {

    @Override
    public void handle(String stmt, ClientConn c) {
        c.getLoadDataInfileHandler().start(stmt);
    }

    @Override
    public int type() {
        return SQLHandler.Type.LOAD_DATA_INFILE_SQL;
    }
