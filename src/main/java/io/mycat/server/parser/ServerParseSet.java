...
public final class ServerParseSet {
    ...
    /**处理SET SESSION $var={key:value} $var标记的为用户自定义变量,
     * 用于mycat扩展[add by jeff.cao 可以根据客户端参数加载不同的配置]
     */
    public static final String EXT_SESSION_VAR          = "$var";
    public static final int    SESSION_VAR_SET          = 13;
